...
\label{sec:metadata}
A vocabulary consists of a collection of terms (classes and properties) expressed in W3C RDF, RDFS, OWL languages. A vocabulary is used to describe linked data on the Web. At the Vocabulary level, LOV Bot extracts three types of information (cf. figure \ref{fig:dcat}):
\begin{itemize}
