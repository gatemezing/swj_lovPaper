...
YASGUI (Yet Another SPARQL Query GUI)\footnote{\url{http://yasgui.laurensrietveld.nl}} is a client-side JavaScript SPARQL query editor that uses LOV autocomplete API for property and class together with \url{http://prefix.cc} for namespace prefix autocompletion \cite{yasgui}.
