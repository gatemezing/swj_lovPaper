...
\begin{inparaenum}[1)] 
  ...
  \item giving access to the data using various indexes and publication methods to ease data consumption.
\end{inparaenum}
...
LOV system (code and data) is published under Creative Commons 4.0 license\footnote{\url{https://creativecommons.org/licenses/by/4.0/}} (CC BY 4.0). Three methods are offered for users and applications to access LOV data:
		\begin{inparaenum}[1)] 
			...
			\item run SPARQL queries on LOV SPARQL Endpoint; and
...
As of today, LOV database contains over 46,000 RDF vocabulary terms, with 28,000 properties and 18,000 classes. The evolution of the number of vocabularies in LOV is illustrated in figure \ref{fig:evolLOV}. LOV is supporting the emergence of a rich application ecosystem thanks to its various data access methods. We list below some tools using our system as part of their service and projects using LOV as a research artifact.
