...
%LOV supports various activities for the design of ontologies and the publication of data on the Web. Based on the NeOn Methodology's glossary of activities for building ontologies, the LOV system is relevant in three activities  \cite{MC10}:
...
To name some examples of the actual use of LOV in this activities we can mention the work described in \cite{villata2012} where authors make use of LOV for looking for terms related to licensing in order to align them increasing interoperability among vocabularies. This is an example of real use of LOV during ontology search and ontology mapping. In the case of \cite{pedrinaci2014}, LOV is used to search for ontologies covering certain terms and also to know the number the datasets using such terms. In this case, we observe a use of LOV to ontology search and assessment according to the vocabulary popularity. Finally, in a more general way, the work presented in \cite{ohdeploying} explore the potential role of LOV in supporting better access to various open datasets and facilitating effective linking. In such work, LOV is compared with other open data repositories and examples of its usefulness for different activities in the field of library linked data is reported.
...
Browsing ontologies	   & Yes & Yes & Yes & Yes & Yes \\ \hline
...
% change the text below to remove the bullets and replace with text on the weakness of the tool
...
Finally, we plan to provide a user study and publish the results on the described use cases of LOV.
