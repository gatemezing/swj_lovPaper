...
\begin{figure}[tb]
	...
	}    	}{ A㥰ʐ  ���Aʐ  ◼J  蓄J쬀Ў���Aʐ  	 吠塥⸀捴㭬   {    潃畬湭:散:羀ʕ碐ʏ    ◼J  蓄J쮰Ў  {瑵潴nะʫ 匦潴湲o
 \end{figure}
...
\item term labels with their predicate (e.g. \url{rdfs:label} \url{"Temperature"@en}). This information is provided for indexing by the search engine and will later be used (cf. section \ref{sssec:search}) in the ranking algorithm.
\end{itemize}
